...
- Default `code=silent` speech does not read code literally. It summarizes implementation references into short phrases such as `python code - test transform for speech` or `file skip listener`.
